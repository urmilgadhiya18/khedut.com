...
//   const [popup, setPopup] = useState({ show: false, email: '' });
...
//   const handleBuyNow = (email) => {
//     setPopup({ show: true, email: email });
//   };

//   const handleClosePopup = () => {
//     setPopup({ show: false, email: '' });
//     setRating(0); // Reset rating when closing the popup
//   };

//   const handleSubmitRating = () => {
//     // console.log(popup.seller,rating);
...
//             <button
//             onClick={() => handleBuyNow(product.email)}
